...
## Learning Objective
Blocks, arguments, identifiers, comments, expressions and file organization.
...
## Practical Lab
Build main.tf, variables.tf, locals.tf and outputs.tf. Explain why Terraform treats the top-level files as one module.
...
## Interview Q&A
**Q1. What is the core concept of HCL Syntax?**  
