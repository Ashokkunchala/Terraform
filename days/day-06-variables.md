...
## Learning Objective
Types, defaults, nullable, validation, sensitive and tfvars.
...
## Practical Lab
Create a typed input contract for environment, region and CIDR.
...
## Interview Q&A
**Q1. What is the core concept of Variables?**  
