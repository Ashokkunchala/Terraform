...
## Learning Objective
Sensitive values, secret stores, injection and state exposure.
...
## Practical Lab
Replace hard-coded credentials with Secrets Manager references.
...
## Interview Q&A
**Q1. What is the core idea of Secrets?**  
