...
## Learning Objective
prevent_destroy, ignore_changes, create_before_destroy and replace.
...
## Practical Lab
Protect a database and make application replacement predictable.
...
## Interview Q&A
**Q1. What is the core idea of Lifecycle?**  
