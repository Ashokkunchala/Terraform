...
## Learning Objective
lookup, try, can, coalesce, merge, flatten, distinct, zipmap and CIDR functions.
...
## Practical Lab
Create a transformation lab with nested objects.
...
## Interview Q&A
**Q1. What is the core concept of Functions?**  
