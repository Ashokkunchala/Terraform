...
## Learning Objective
Static platform using S3, CloudFront, ACM, Route53, modules and CI.
...
## Practical Lab
Deliver architecture, tests, security scan, cost estimate and runbook.
...
## Interview Q&A
**Q1. What is the core idea of Capstone 1?**  
